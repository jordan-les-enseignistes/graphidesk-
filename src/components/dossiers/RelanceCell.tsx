          ...
          <div className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                >
                  <input
                    ...
                    className="sr-only"
                  />
                  <Mail className={`h-5 w-5 ${relanceMail ? "text-orange-600" : "text-gray-400"}`} />
                  <span className={`text-sm font-medium ${relanceMail ? "text-orange-800" : "text-gray-600"}`}>
                    Mail
                  </span>
                </label>
                ...
                >
                  <input
                    ...
                    className="sr-only"
                  />
                  <Phone className={`h-5 w-5 ${relanceTel ? "text-orange-600" : "text-gray-400"}`} />
                  <span className={`text-sm font-medium ${relanceTel ? "text-orange-800" : "text-gray-600"}`}>
                    Téléphone
                  </span>
                </label>
              </div>
            ...
            {canConfirm && (
              <div className="bg-gray-50 rounded-lg p-3">
                <p className="text-xs text-gray-500 mb-1">Aperçu du commentaire :</p>
